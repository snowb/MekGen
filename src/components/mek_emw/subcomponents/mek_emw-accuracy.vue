        ...
        <div class="metallic_background_small">
            <div class="subsection_container">
                ...
                <table style="margin:auto;">
                    <tr v-if="!isBeamShield || isVariableBeamShield">
                        <td class="head_column">WA</td>
                        <td>&nbsp;</td>
                        <td v-for="(acc,index) in accuracy_table" :key="'emw-accuracy-'+index"
                            class="clickable"
                    ...
                    <tr v-if="isBeamShield">
                        <td class="head_column">DA</td>
                        <td>&nbsp;</td>
                        <td v-for="(acc,index) in accuracy_table" :key="'emw-da-'+index"
                            class="clickable"
                            :class="selectedItem('accuracy_index',index,'selected_item_top')"
                            style="padding:2px 5px;"
                            @click="select_accuracy(acc)"
                    ...
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td v-for="(acc,index) in accuracy_table" :key="'emw-cost-'+index"
                            class="clickable" 
